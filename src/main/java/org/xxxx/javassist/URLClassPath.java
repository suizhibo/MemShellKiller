...
public class URLClassPath implements ClassPath {
     ...
     * If <code>packageName</code> is "org.org.xxxx.javassist." and a requested class is
     * "org.org.xxxx.javassist.test.Main", then the given URL is used for loading that class.
     * The <code>URLClassPath</code> obtains a class file from:
     *
     * <pre>http://www.org.xxxx.javassist.org:80/java/classes/org/org.xxxx.javassist/test/Main.class
     * </pre>
     *
     * <p>Here, we assume that <code>host</code> is "www.org.xxxx.javassist.org",
