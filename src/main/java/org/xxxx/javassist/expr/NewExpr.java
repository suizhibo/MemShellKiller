...
package org.xxxx.javassist.expr;

import org.xxxx.javassist.*;
import org.xxxx.javassist.bytecode.*;
import org.xxxx.javassist.compiler.*;
import org.xxxx.javassist.compiler.ast.ASTList;
...
public class NewExpr extends Expr {
    ...
    */
    ...
    private int canReplace() throws CannotCompileException {
        ...
        if (op == DUP)     // Typical single DUP or Javaflow DUP DUP2_X2 POP2
            return ((iterator.byteAt(newPos + 4) == DUP2_X2
                 && iterator.byteAt(newPos + 5) == POP2)) ? 6 : 4;
        else if (op == DUP_X1
