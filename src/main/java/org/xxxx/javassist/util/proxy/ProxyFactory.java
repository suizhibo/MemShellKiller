 ...
 * with previous releases of org.xxxx.javassist. Unfortunately,this legacy behaviour makes caching
 * and reuse of proxy classes impossible. The current programming model expects org.xxxx.javassist
 ...
 * to serialize and deserialize, respectively, the proxy. These streams recognise org.xxxx.javassist proxies and ensure
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "org.xxxx.javassist.util.proxy.RuntimeSupport";
     ...
     * setting retains the old org.xxxx.javassist behaviour which has the advantage that it
    ...
    /**
     * determine if a class is a org.xxxx.javassist proxy class
     * @param cl
     * @return true if the class is a org.xxxx.javassist proxy class otherwise false
     */
    ...
    protected ClassLoader getClassLoader0() {
        ...
        if (loader == null) {
            ...
            // In case org.xxxx.javassist is in the endorsed dir
            if (loader == null) {
    ...
    private void checkClassAndSuperName() {
        ...
        if (basename.startsWith("java."))
            basename = "org.org.xxxx.javassist.tmp." + basename;
    }
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("org.xxxx.javassist.util.proxy.RuntimeSupport",
                             "makeSerializedProxy",
