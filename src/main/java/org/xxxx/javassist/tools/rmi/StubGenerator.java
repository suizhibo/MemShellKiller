...
package org.xxxx.javassist.tools.rmi;
...
public class StubGenerator implements Translator {
    ...
    private static final String sampleClass = "org.xxxx.javassist.tools.rmi.Sample";
     ...
     * This is a method declared in org.xxxx.javassist.Translator.
     *
    ...
    public void start(ClassPool pool) throws NotFoundException {
        ...
        proxyConstructorParamTypes
            = pool.get(new String[] { "org.xxxx.javassist.tools.rmi.ObjectImporter",
                                         "int" });
        interfacesForProxy
            = pool.get(new String[] { "java.io.Serializable",
                                         "org.xxxx.javassist.tools.rmi.Proxy" });
        exceptionForProxy
            = new CtClass[] { pool.get("org.xxxx.javassist.tools.rmi.RemoteException") };
    }
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtField f
            = new CtField(classPool.get("org.xxxx.javassist.tools.rmi.ObjectImporter"),
                          fieldImporter, proxy);
