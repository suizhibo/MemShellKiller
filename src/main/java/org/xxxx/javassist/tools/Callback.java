...
import org.xxxx.javassist.CtBehavior;
...
public abstract class Callback {
    ...
    public Callback(String src){
        ...
        sourceCode = "((org.xxxx.javassist.tools.Callback) org.xxxx.javassist.tools.Callback.callbacks.get(\""+uuid+"\")).result(new Object[]{"+src+"});";
    }
