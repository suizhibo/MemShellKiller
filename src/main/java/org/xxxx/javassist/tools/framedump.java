 ...
 * License.
 */
package org.xxxx.javassist.tools;

import org.xxxx.javassist.ClassPool;
import org.xxxx.javassist.CtClass;
import org.xxxx.javassist.bytecode.analysis.FramePrinter;
 ...
 *
 * <p>For example,
 * <pre>% java org.xxxx.javassist.tools.framedump foo.class</pre>
 */
public class framedump {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 1) {
            System.err.println("Usage: java org.xxxx.javassist.tools.framedump <fully-qualified class name>");
            return;
        }
