...
package org.xxxx.javassist.tools.web;
 ...
 *
 * <pre>% java org.xxxx.javassist.tools.web.Viewer <i>host port</i> Main arg1, ...</pre>
 *
 ...
 * <code>org.xxxx.javassist.*</code> classes are not needed at the client side.
...
public class Viewer extends ClassLoader {
    ...
    public static void main(String[] args) throws Throwable {
        if (args.length >= 3) {
            ...
            System.err.println(
        "Usage: java org.xxxx.javassist.tools.web.Viewer <host> <port> class [args ...]");
    }
    ...
    protected Class findClass(String name) throws ClassNotFoundException {
        ...
        if (name.startsWith("java.") || name.startsWith("javax.")
            || name.equals("org.xxxx.javassist.tools.web.Viewer"))
