...
package org.xxxx.javassist.tools.reflect;
 ...
 *     org.xxxx.javassist.tools.reflect.Loader cl
 *         = (org.xxxx.javassist.tools.reflect.Loader)Main.class.getClassLoader();
 *     cl.makeReflective("Person", "MyMetaobject",
 *                       "org.xxxx.javassist.tools.reflect.ClassMetaobject");
 *     cl.run("MyApp", args);
 *   }
 * }
 * </pre>
 ...
 *
 * <pre>% java org.xxxx.javassist.tools.reflect.Loader Main arg1, ...</pre>
 *
 ...
 * public class Main2 {
 *   public static void main(String[] args) throws Throwable {
 *     org.xxxx.javassist.tools.reflect.Loader cl = new org.xxxx.javassist.tools.reflect.Loader();
 *     cl.makeReflective("Person", "MyMetaobject",
 *                       "org.xxxx.javassist.tools.reflect.ClassMetaobject");
 *     cl.run("MyApp", args);
 *   }
 ...
 * is loaded by <code>org.xxxx.javassist.tools.reflect.Loader</code> whereas the class
 ...
 * to the same name space as <code>org.xxxx.javassist.tools.reflect.Loader</code>.
 * For more details,
 * see the notes in the manual page of <code>org.xxxx.javassist.Loader</code>.
 *
 ...
 *     org.xxxx.javassist.Loader cl
 *         = new org.xxxx.javassist.Loader(ClassPool.getDefault(reflection));
 ...
 * <p><b>Note:</b>
 *
 * <p><code>org.xxxx.javassist.tools.reflect.Loader</code> does not make a class reflective
 ...
 * modified with <code>org.xxxx.javassist.tools.reflect.Compiler</code> and the original
 * class files should be replaced.
 *
 * @see Reflection
 * @see java.lang.Compiler
 * @see org.xxxx.javassist.Loader
 */
public class Loader extends org.xxxx.javassist.Loader {
    ...
    public Loader() throws CannotCompileException, NotFoundException {
        super();
        delegateLoadingOf("org.xxxx.javassist.tools.reflect.Loader");
