 ...
 * without <code>org.xxxx.javassist.tools.reflect.Loader</code>
...
public class Compiler {
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (entries[i].metaobject != null
                ...
                if (entries[i].metaobject == null)
                    metaobj = "org.xxxx.javassist.tools.reflect.Metaobject";
                else
                    metaobj = entries[i].metaobject;

                if (entries[i].classobject == null)
                    classobj = "org.xxxx.javassist.tools.reflect.ClassMetaobject";
                else
    ...
    private static void help(PrintStream out) {
        out.println("Usage: java org.xxxx.javassist.tools.reflect.Compiler");
