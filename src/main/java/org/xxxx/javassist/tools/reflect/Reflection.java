...
import org.xxxx.javassist.CtMethod.ConstParameter;
import org.xxxx.javassist.bytecode.BadBytecode;
import org.xxxx.javassist.bytecode.ClassFile;
import org.xxxx.javassist.bytecode.MethodInfo;
...
public class Reflection implements Translator {
    ...
    static final String metaobjectClassName = "org.xxxx.javassist.tools.reflect.Metaobject";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        classPool = pool;
        final String msg
            = "org.xxxx.javassist.tools.reflect.Sample is not found or broken.";
        try {
            CtClass c = classPool.get("org.xxxx.javassist.tools.reflect.Sample");
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtClass mlevel = classPool.get("org.xxxx.javassist.tools.reflect.Metalevel");
        ...
        CtField f;
        if (addMeta) {
            f = new CtField(classPool.get("org.xxxx.javassist.tools.reflect.Metaobject"),
        ...
        f = new CtField(classPool.get("org.xxxx.javassist.tools.reflect.ClassMetaobject"),
